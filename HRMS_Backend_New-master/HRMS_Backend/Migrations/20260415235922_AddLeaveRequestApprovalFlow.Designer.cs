...
namespace HRMS_Backend.Migrations
{
    ...
    [Migration("20260415235922_AddLeaveRequestApprovalFlow")]
    partial class AddLeaveRequestApprovalFlow
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HRMS_Backend.Models.EmployeeAdministrativeData", b =>
                {
                    ...
                    b.HasIndex("SecondmentToEntityId");

                    b.HasIndex("SectionId");

                    b.HasIndex("SubDepartmentId");

                    b.HasIndex("TransferFromEntityId");
            ...
            modelBuilder.Entity("HRMS_Backend.Models.EmployeeAdministrativeData", b =>
                {
                    ...
                    b.HasOne("HRMS_Backend.Models.Employee", "SecondmentToEntity")
                        .WithMany()
                        .HasForeignKey("SecondmentToEntityId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("HRMS_Backend.Models.Employee", "TransferFromEntity")
                        .WithMany()
                        .HasForeignKey("TransferFromEntityId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("SecondmentToEntity");

                    b.Navigation("Section");

                    b.Navigation("SubDepartment");

                    b.Navigation("TransferFromEntity");
