...
namespace HRMS_Backend.Migrations
{
    ...
    [Migration("20260501230113_AddRequestWorkflowFieldstfdruytri")]
    partial class AddRequestWorkflowFieldstfdruytri
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMS_Backend.Models.EmployeeAdministrativeData", b =>
                {
                    ...
                    b.Property<int?>("SecondmentToOrganizationId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TransferFromOrganizationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SecondmentToOrganizationId");

                    b.HasIndex("SectionId");

                    b.HasIndex("SubDepartmentId");

                    b.HasIndex("TransferFromOrganizationId");
            ...
            modelBuilder.Entity("HRMS_Backend.Models.LeaveTypes", b =>
                {
                    ...
                    b.Property<bool>("IsAffectedByHolidays")
                        .HasColumnType("bit")
                        .HasColumnName("تتأثر_بالعطلات_الرسمية");
            ...
            modelBuilder.Entity("HRMS_Backend.Models.ManagerDelegation", b =>
                {
                    ...
                    b.Property<int>("ActingManagerId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OriginalManagerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMS_Backend.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 15,
                            PermissionName = "ManageMaintenance"
                        },
                        new
                        {
                            Id = 16,
                            PermissionName = "ManageSalaryCertificates"
                        },
                        new
                        {
                            Id = 17,
                            PermissionName = "ManageExitPermits"
                        },
                        new
                        {
                            Id = 18,
            ...
            modelBuilder.Entity("HRMS_Backend.Models.Qualification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMS_Backend.Models.DataUpdateRequest", b =>
                {
                    b.HasOne("HRMS_Backend.Models.Employee", "AssignedTo")
                        .WithMany()
                        .HasForeignKey("AssignedToEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("HRMS_Backend.Models.Employee", "ClaimedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMS_Backend.Models.EmployeeAdministrativeData", b =>
                {
                    ...
                    b.HasOne("HRMS_Backend.Models.Organization", "SecondmentToOrganization")
                        .WithMany()
                        .HasForeignKey("SecondmentToOrganizationId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("HRMS_Backend.Models.Organization", "TransferFromOrganization")
                        .WithMany()
                        .HasForeignKey("TransferFromOrganizationId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("SecondmentToOrganization");

                    b.Navigation("Section");

                    b.Navigation("SubDepartment");

                    b.Navigation("TransferFromOrganization");
            ...
            modelBuilder.Entity("HRMS_Backend.Models.EmployeeEducation", b =>
                {
                    ...
                    b.HasOne("HRMS_Backend.Models.Qualification", "Qualification")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMS_Backend.Models.ManagerDelegation", b =>
                {
                    b.HasOne("HRMS_Backend.Models.Employee", "ActingManager")
                        .WithMany()
                        .HasForeignKey("ActingManagerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("HRMS_Backend.Models.Employee", "OriginalManager")
                        .WithMany()
                        .HasForeignKey("OriginalManagerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ActingManager");

                    b.Navigation("AssignedBy");

                    b.Navigation("OriginalManager");
                });
